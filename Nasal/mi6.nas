...
#############################################################################################################
# Speedfilter for less than 60 kts
#
  
setlistener("/instrumentation/airspeed-indicator/indicated-speed-kt", func
{  
  if (getprop("/instrumentation/airspeed-indicator/indicated-speed-kt") < 90 )
     setprop("/controls/flight/slowspeed", 0);
  else setprop("/controls/flight/slowspeed", 1);
});   
